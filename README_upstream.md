...
> This is the original README of
> [dreminm/project-2-pareto-iqa](https://github.com/dreminm/project-2-pareto-iqa),
> kept for reference. The repository's own work is described in
> [README.md](README.md).
